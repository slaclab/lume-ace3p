...
- [~] `s3p_mf_optimization` — run 1 (job 37728605) FAILED after 2m05s: the first random batch included mesh_fidelity 0 (4 mm mesh, 2634 elements) and S3P died with SIGFPE (signal 8) over 16 ranks; diag job 37729506 showed 16 ranks fail deterministically, 8 and 4 ranks succeed. Example (and s3p_bayesian_sweep, same journal) moved to 8×4 in 1e51dfc. Run 2 (job 37730046, 30-min allotted time) submitted. **Update when done.**
